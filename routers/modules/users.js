...
router.put('/avatar/:userId', upload.single('avatar'), userController.editUserAvatar) // 編輯user 大頭貼
router.put('/password/:userId', userController.editPassword) // 編輯user password
